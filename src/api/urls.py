from .views import AccountActivatedView, BaseView, ChangePasswordView, GetClassifiedAsView, GetClassifiedByView, GetDataView, GuestView, LoginView, LogoutView, MapView, PasswordChangedView, RegisterView, SendActivationEmailView, SendChangePasswordEmailView
...
urlpatterns = [
    ...
    path("get_data/<parameters>/", GetDataView.as_view(), name="get_data_view"),
]
