...
# This function takes all images from a set directory and outputs the filenames of all non-blank tiles into tilenames.csv
# The point of this function is to have a textual representation of all tiles containing information, in order to only add them in the database
